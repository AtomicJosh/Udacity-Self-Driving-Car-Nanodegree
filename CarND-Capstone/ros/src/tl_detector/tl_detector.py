...
TEST_MODE_ENABLED = False # True for /vehicle/traffic_lights ground truth data; False for model prediction data
SAVE_IMAGES = False
LOG_RATE = 5  # Only log at this rate (1 / Hz)
...
class TLDetector(object):
    ...
    def get_light_state(self, light):
        ...
        # For test mode, return the light state
        if TEST_MODE_ENABLED:
            ...
            # Save image
            if SAVE_IMAGES and (self.process_count % LOG_RATE == 0):
    ...
    def process_traffic_lights(self):
        ...
        if closest_light:
            ...
            if (self.process_count % LOG_RATE) == 0:
