...
MAX_DECEL = 0.5
LOG_RATE = 40  # Only log at this rate (1 / Hz)
...
class WaypointUpdater(object):
    ...
    def loop(self):
        rate = rospy.Rate(20) # The waypoint publishing rate in hz
    ...
    def publish_waypoints(self):
        ...
        if (self.red_light_waypoint == -1) or (self.red_light_waypoint >= farthest_idx):
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            stop_idx = max(self.red_light_waypoint - closest_idx - STOP_LINE_MARGIN, 0)
        ...
        if (self.decelerate_count % LOG_RATE) == 0:
    ...
    def traffic_cb(self, msg):
        if self.red_light_waypoint != msg.data:
            rospy.logwarn("LIGHT: new red_light_waypoint={}, old red_light_waypoint={}".format(msg.data, self.red_light_waypoint))
